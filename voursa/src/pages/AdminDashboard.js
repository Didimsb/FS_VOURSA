                                      ...
                                      <Input type="file" accept="image/*" w="full" onChange={async (e) => {
                                        ...
                                        if (file) {
                                          try {
                                            ...
                                            toast({ title: "تم رفع الصورة بنجاح", status: "success", duration: 3000, isClosable: true });
                                          } catch (error) {
                                            toast({ title: "خطأ", description: "فشل في رفع الصورة", status: "error", duration: 3000, isClosable: true });
                                          }
                                        }
                                      }} />
                                    </VStack>
